# Contribute to `scaleway-cloud-controller-manager`

`scaleway-cloud-controller-manager` is Apache 2.0 licensed and accepts contributions via GitHub.
...
- The version of `scaleway-cloud-controller-manager` you are using (v0.1.3, v0.2.4, master, ...)
...
- Does this align with the goals of `scaleway-cloud-controller-manager` ?
...
- Open a pull request against `scaleway-cloud-controller-manager` master branch that follows [PR guidelines](#pull-request-guidelines)

The maintainers of `scaleway-cloud-controller-manager` use a "Let's Get This Merged" (LGTM) message in the pull request to note that the commits are ready to merge.
